    ...
    <div>
        ...
        <div class="col-md-6">
          ...
          <div class="alert alert-info alert-with-icon" data-notify="container">
            ...
            <span data-notify="message"
              ...
              that the icon and the close button are always vertically aligned. This is a beautiful
      ...
      <div class="places-buttons">
        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-md-3">
            <p-button round outline block @click.native="notifyVue('top', 'center')"
              >Top Center</p-button
            >
          </div>
          <div class="col-md-3">
            <p-button round outline block @click.native="notifyVue('top', 'right')"
              >Top Right</p-button
            >
          </div>
        </div>
        <div class="row d-flex justify-content-center">
          <div class="col-md-3">
            <p-button round outline block @click.native="notifyVue('bottom', 'left')"
              >Bottom Left</p-button
            >
          </div>
          <div class="col-md-3">
            <p-button round outline block @click.native="notifyVue('bottom', 'center')"
              >Bottom Center</p-button
            >
          </div>
          <div class="col-md-3">
            <p-button round outline block @click.native="notifyVue('bottom', 'right')"
